...
class R2RNavBatch(object):
    ...
    #     gt_path=[
    #   "0bcfce0d81294b7e84a7eed52cb04a4e",
    #   "4bb7642a8af44f97acb81190589a3451",
    #   "34a370fe2d1840e196a491db1e995e16",
    ...
    #   "c4fc538718cc4918884d2040ce523a5f",
    #   "e0c61a2e0f9244cd8534e9ed8be96322",
    #   "673ae67937804c42b3c22e93efb5d069",
    #   "fea7a9db41944d76b258036b046d13aa",
    #   "32fb55017460457cbe0b8d1790a54786",
    #   "e5f8d864ab7545d3bae0e56a527041ec",
    #   "d0a013ec97674abc8fd7657ea7844221",
    #   "a844e7823fe4425f96a265b8fc557cb7"
    #     ]
    #     set_trace()
    #     for i, vp in enumerate(gt_path[:-1]):
    #         self.env.newEpisodes(scanIds, [vp], headings)
    #         self.env.sims[0].makeAction([0], [0], [0])
    #         obs= self._get_obs()
    #         headings = [obs[0]['heading']]
    #         print(headings)
